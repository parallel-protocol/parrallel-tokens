...
export interface IBridgeableTokenPInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approvalRequired"
      | "oftVersion"
...
export interface IBridgeableTokenP extends BaseContract {
  connect(runner?: ContractRunner | null): IBridgeableTokenP;
  waitForDeployment(): Promise<this>;

  interface: IBridgeableTokenPInterface;
